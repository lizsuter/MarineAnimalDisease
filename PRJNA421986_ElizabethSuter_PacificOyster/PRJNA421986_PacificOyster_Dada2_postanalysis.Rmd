---
title: "Comparison of Output from 2 Amplicon Pipelines- Here I am processing the data from the Dada2/Decipher pipeline"
author: "Liz Suter"
date: "6/28/2020"
---
...
```
There are lots of Vibrionaceae here that are higher in the heat stressed (25C) samples than T0. Also Pseudoalteromonadaceae, Nitrincolaceae, Rhodobacteraceae. This is all similar to the QIIME results
Something different than QIIME results: This also identified 2 Arcobacteraceae ASVs: 1 that was higher in the T0 and one that was higher in the 25C. 
Arcobacter have been identified as possible pathogens in addition to Vibrio
